    ...
    <div class="ibox">
        ...
        <div class="ibox-body">
            <form action="<?= base_url('bahan/update_bahan') ?>" method="POST">
                {data_bahan}
                <div class="row">
                        <input type="hidden" name="id_bahan" id="" placeholder="input id" value="{id_bahan}" class="form-control" maxlength="5" />
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <textarea name="kandungan_bahan" id="kandungan_bahan" cols="30" rows="10" class="form-control" maxlength="500" placeholder="tulis disini...">{kandungan_bahan}</textarea>
                    </div>
